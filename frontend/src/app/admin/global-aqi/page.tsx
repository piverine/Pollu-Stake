...
export default function GlobalAQIPage() {
    ...
    return (
        <div className="space-y-6 p-8">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {cities.map((city) => (
                    <Link
                        href={`/admin/global-aqi/${encodeURIComponent(city.name)}`}
                        key={city.name + (city.uid || '')}
                        className="group relative block overflow-hidden rounded-2xl border border-charcoal-200 bg-white p-6 shadow-sm transition-all hover:shadow-md hover:border-primary-200"
                    >
